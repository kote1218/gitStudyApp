...
import { Stage, Task, Badge, Slide } from '../types';
...
// Slide components and data
interface SlideProps {
  slides: Slide[];
  onComplete: () => void;
}

export const SlideViewer: React.FC<SlideProps> = ({ slides, onComplete }) => {
...
// Conflict Resolution Introduction Slides
export const conflictIntroSlides: Slide[] = [
  {
    id: 1,
    title: "コンフリクト解決マスター編へようこそ！",
    content: (
      <div className="text-center space-y-8">
        <div className="text-6xl mb-6">⚡</div>
        <h3 className="text-2xl font-bold text-gray-800 mb-4">
          コンフリクトは「怖いもの」ではありません
        </h3>
        <div className="bg-blue-50 border-l-4 border-blue-500 p-6 text-left max-w-2xl mx-auto">
          <p className="text-lg text-gray-700 mb-4">
            コンフリクトは、<strong className="text-blue-600">「複数の人が同じ箇所を編集した時にGitが教えてくれる親切な機能」</strong>です。
          </p>
          <div className="space-y-3">
            <p className="text-gray-600">🤔 「どちらの変更を採用すべき？」</p>
            <p className="text-gray-600">🔍 「両方の内容を統合できる？」</p>
            <p className="text-gray-600">✅ 「人間が判断して解決しよう」</p>
          </div>
          <p className="text-blue-600 font-semibold mt-4">
            正しい手順を覚えれば、落ち着いて対処できます！
          </p>
        </div>
      </div>
    )
  ...
  {
    id: 2,
    title: "今回のシナリオ：同時編集でコンフリクト発生",
    content: (
      <div className="space-y-8">
        <div className="text-center">
          <div className="text-5xl mb-4">👥</div>
          <p className="text-lg text-gray-700 mb-6">
            あなたとチームメンバーのAさんが、同じファイルの同じ箇所を編集しました
          </p>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          ...
          <div className="space-y-3">
            <p className="text-yellow-700">👨‍💻 <strong>Aさん</strong>：index.htmlの見出しを「Hello from Team!」に変更してmainにpush済み</p>
            <p className="text-yellow-700">👤 <strong>あなた</strong>：feature-titleブランチで同じ見出しを「Welcome to My Site」に変更</p>
            <p className="text-yellow-700">⚡ <strong>結果</strong>：mainにマージしようとするとコンフリクト発生！</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <h4 className="text-lg font-semibold text-red-800 mb-2 text-center">Aさんの変更</h4>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 className="text-lg font-semibold text-blue-800 mb-2 text-center">あなたの変更</h4>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <p className="text-center text-gray-700">
            「同じ&lt;h1&gt;タグに2つの異なる内容があります。<br />
            どちらを採用するか、または統合するか、人間が決めてください」
          </p>
        </div>
      </div>
    )
  ...
  {
    id: 3,
    title: "コンフリクト解決の5ステップ",
    content: (
      <div className="space-y-8">
        <div className="text-center">
          <p className="text-lg text-gray-700 mb-6">
            コンフリクト解決は<strong className="text-blue-600">決まった手順</strong>があります
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-red-800">コンフリクト発生を確認</h4>
                <p className="text-red-600">ターミナルに「CONFLICT」メッセージが表示</p>
              </div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-red-200">
              <code className="block text-sm font-mono bg-gray-100 px-3 py-2 rounded mb-2">
              ...
              <p className="text-gray-600 text-sm">→ index.htmlでコンフリクトが発生したことを通知</p>
            </div>
          </div>
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-orange-800">コンフリクトマーカーを確認</h4>
                <p className="text-orange-600">ファイル内に特殊なマーカーが追加される</p>
              </div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-orange-200">
              <code className="block text-sm font-mono bg-gray-100 px-3 py-2 rounded whitespace-pre">
{`<<<<<<< HEAD
  <h1>Hello from Team!</h1>
=======
  <h1>Welcome to My Site</h1>
>>>>>>> feature-title`}
              ...
              <p className="text-gray-600 text-sm mt-2">→ 上がmain（HEAD）、下があなたのブランチの内容</p>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-yellow-800">内容を統合して編集</h4>
                <p className="text-yellow-600">マーカーを削除し、最終的な内容を決定</p>
              </div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-yellow-200">
              <code className="block text-sm font-mono bg-gray-100 px-3 py-2 rounded mb-2">
                &lt;h1&gt;Welcome to My Site and Team!&lt;/h1&gt;
              </code>
              <p className="text-gray-600 text-sm">→ 両方の内容を統合した最終版</p>
            </div>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-green-800">解決済みファイルをステージング</h4>
                <p className="text-green-600">Gitに「解決完了」を通知</p>
              </div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-green-200">
              <code className="block text-sm font-mono bg-gray-100 px-3 py-2 rounded mb-2">
              ...
              <p className="text-gray-600 text-sm">→ 「このファイルのコンフリクトは解決済み」とGitに伝える</p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-blue-800">マージコミット完了</h4>
                <p className="text-blue-600">統合作業を正式に記録</p>
              </div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-blue-200">
              <code className="block text-sm font-mono bg-gray-100 px-3 py-2 rounded mb-2">
              ...
              <p className="text-gray-600 text-sm">→ マージコミットが作成され、ブランチが統合される</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="text-center space-y-8">
        ...
        <div className="bg-blue-50 rounded-lg p-6">
          ...
          <div className="space-y-3 text-left max-w-2xl mx-auto">
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-blue-600 font-semibold">1. </span>
              <span className="text-gray-700">feature-titleブランチを作成・切り替え</span>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-green-600 font-semibold">2. </span>
              <span className="text-gray-700">見出しを「Welcome to My Site」に変更・コミット</span>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-yellow-600 font-semibold">3. </span>
              <span className="text-gray-700">mainに戻ってAさんの変更を模擬</span>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-red-600 font-semibold">4. </span>
              <span className="text-gray-700">マージ実行でコンフリクト発生</span>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-purple-600 font-semibold">5. </span>
              <span className="text-gray-700">コンフリクトを解決してマージ完了</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <p className="text-gray-700">
            一度経験すれば、実務でコンフリクトが起きても慌てることはありません。
          </p>
...
// Practical Workflow Introduction Slides
export const practicalIntroSlides: Slide[] = [
  {
    id: 1,
    title: "実務模擬シナリオへようこそ！",
    content: (
      <div className="text-center space-y-8">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-6 text-left max-w-2xl mx-auto">
          <p className="text-lg text-gray-700 mb-4">
            あなたはWeb制作チームの一員です。<br />
            チームリーダーから<strong className="text-blue-600">「Issue #12: ヘッダー追加」</strong>のタスクが割り当てられました。
          </p>
          <div className="space-y-3">
            <p className="text-gray-600">📋 Issue対応</p>
            <p className="text-gray-600">🌿 ブランチ作成</p>
            <p className="text-gray-600">💾 開発・コミット</p>
            <p className="text-gray-600">🚀 PR作成・マージ</p>
          </div>
          <p className="text-blue-600 font-semibold mt-4">
            GitHub Flowの完全な流れを体験します！
          </p>
        </div>
        
        <div className="bg-gray-50 rounded-lg p-4">
          <h4 className="text-lg font-semibold text-gray-800 mb-2">チーム構成</h4>
          <div className="space-y-2">
            <p className="text-gray-700">👨‍💼 田中さん（プロジェクトマネージャー）</p>
            <p className="text-gray-700">👩‍💻 佐藤さん（シニア開発者）</p>
            <p className="text-gray-700">🆕 あなた（開発者）</p>
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="space-y-8">
        <div className="text-center">
          <p className="text-lg text-gray-700 mb-6">
            GitHub Flowは<strong className="text-blue-600">実際の開発現場で最も使われているワークフロー</strong>です
          </p>
        </div>

        <div className="bg-gray-50 rounded-lg p-6">
          <h4 className="text-lg font-semibold text-gray-800 mb-4 text-center">基本原則</h4>
          
          <div className="space-y-4">
            <div className="flex items-center">
              <div className="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4">✓</div>
              <div>
                <h5 className="font-semibold text-gray-800">mainブランチは常にデプロイ可能</h5>
                <p className="text-gray-600 text-sm">本番環境にいつでもリリースできる安定した状態を保つ</p>
              </div>
            </div>
            
            <div className="flex items-center">
              <div className="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4">🌿</div>
              <div>
                <h5 className="font-semibold text-gray-800">機能ごとにブランチを作成</h5>
                <p className="text-gray-600 text-sm">新機能やバグ修正は専用ブランチで開発</p>
              </div>
            </div>
            
            <div className="flex items-center">
              <div className="w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4">👥</div>
              <div>
                <h5 className="font-semibold text-gray-800">Pull Requestでレビュー</h5>
                <p className="text-gray-600 text-sm">コードの品質を保つためチームでレビュー</p>
              </div>
            </div>
            
            <div className="flex items-center">
              <div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4">🔗</div>
              <div>
                <h5 className="font-semibold text-gray-800">承認後にmainにマージ</h5>
                <p className="text-gray-600 text-sm">レビュー完了後、安全にmainブランチに統合</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="flex items-center">
              <div className="w-3 h-3 bg-green-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">シンプルで覚えやすい</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-blue-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">チーム全体で品質管理</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-purple-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">継続的デプロイに最適</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-orange-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">問題の早期発見</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-center mb-4">
            <div className="text-3xl mr-4">🎯</div>
            <div>
              <h4 className="text-xl font-bold text-blue-800">Issue #12: ヘッダー追加</h4>
              <p className="text-blue-600">優先度: 中 | 担当者: あなた</p>
            </div>
          </div>
          
          <div className="bg-white rounded-lg p-4 border border-blue-200">
            <h5 className="font-semibold text-gray-800 mb-3">📝 要件</h5>
            <ul className="space-y-2 text-gray-700">
              <li>• サイト上部にナビゲーションヘッダーを追加</li>
              <li>• ホーム、サービス、お問い合わせのリンクを含める</li>
              <li>• レスポンシブデザインに対応</li>
              <li>• 既存のスタイルと統一感を保つ</li>
            </ul>
          </div>
        </div>
    ...
    <ul>
      ...
      <li><a href="#contact">お問い合わせ</a></li>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="space-y-2">
            <p className="text-gray-700">1. <code className="bg-gray-200 px-2 py-1 rounded">feature/add-header</code> ブランチを作成</p>
            <p className="text-gray-700">2. <code className="bg-gray-200 px-2 py-1 rounded">header.html</code> ファイルを作成</p>
            <p className="text-gray-700">3. 変更をコミット・プッシュ</p>
            <p className="text-gray-700">4. Pull Request作成</p>
            <p className="text-gray-700">5. レビュー・マージ・クリーンアップ</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="text-center space-y-8">
        ...
        <div className="bg-blue-50 rounded-lg p-6">
          ...
          <div className="space-y-3 text-left max-w-2xl mx-auto">
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-blue-600 font-semibold">🎯 </span>
              <span className="text-gray-700">Issue駆動開発の体験</span>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-green-600 font-semibold">🌿 </span>
              <span className="text-gray-700">適切なブランチ命名規則</span>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-purple-600 font-semibold">💾 </span>
              <span className="text-gray-700">意味のあるコミットメッセージ</span>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-orange-600 font-semibold">🚀 </span>
              <span className="text-gray-700">Pull Requestの作成・レビュー</span>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <span className="text-red-600 font-semibold">🧹 </span>
              <span className="text-gray-700">マージ後のクリーンアップ</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <p className="text-gray-700">
            これで、実際のチーム開発で即戦力として活躍できるスキルが身につきます。
          </p>
          
          <div className="text-4xl font-bold text-blue-600">
            💼 Let's work like a pro!
          </div>
        </div>

        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <p className="text-green-800 font-medium">
            次から実際の開発フローを体験していきます
          </p>
        </div>
      </div>
    )
...
export const stages: Stage[] = [
  {
    id: 1,
    title: "Git入門",
    description: "Gitの基本概念と仕組みを理解しよう",
    category: "tutorial",
    objectives: [
      "Gitとは何かを理解する",
      "バージョン管理の重要性を学ぶ",
    ...
    tasks: [
      {
        id: "intro-slides",
        description: "Git入門スライドを確認する",
        hint: "スライドを最後まで進めてください",
        check: () => true,
        completed: false
      }
    ],
  ...
  },
  {
    id: 2,
    title: "リポジトリ作成",
    description: "初めてのGitリポジトリを作成し、基本的なワークフローを体験しよう",
    category: "basic",
    objectives: [
      "git initでリポジトリを初期化する",
      "ファイルを作成・編集する",
      "git add, git commitの流れを理解する"
    ],
    initialState: {
      files: {},
      staged: [],
    ...
    tasks: [
      {
        id: "ui-guide",
        description: "画面の使い方を確認する",
        hint: "UIガイドを最後まで進めてください",
        check: () => true,
        completed: false
      },
      {
        id: "init",
        description: "git initでリポジトリを初期化する",
        hint: "ターミナルに「git init」と入力してEnterキーを押してください",
        command: "git init",
      ...
      {
        id: "create-html-file",
        description: "index.htmlファイルを作成する",
        hint: "左側のファイルエディタで「+」ボタンをクリックして新しいファイルを作成してください",
        check: (state) => state.files['index.html'] !== undefined,
        completed: false
      },
      {
        id: "add-hello-git",
        description: "index.htmlに<h1>Hello Git</h1>を追加する",
        hint: "ファイルエディタでindex.htmlを選択し、<h1>Hello Git</h1>と入力してください",
        check: (state) => state.files['index.html']?.includes('<h1>Hello Git</h1>'),
        completed: false
      },
      {
        id: "add",
        description: "git addでファイルをステージングする",
        hint: "ターミナルに「git add index.html」と入力してください",
        command: "git add index.html",
        check: (state) => state.staged.includes('index.html'),
        completed: false
      },
      {
        id: "first-commit",
        description: "初回コミットを作成する",
        hint: "ターミナルに「git commit -m \"Initial commit\"」と入力してください",
    ...
    badge: {
      id: "first-repo",
      name: "初回リポジトリ",
      description: "初めてのGitリポジトリを作成しました",
      icon: "🎯",
      color: "blue",
      earned: false
    },
  ...
  },
  {
    id: 3,
    title: "基礎コマンドマスター",
    description: "git status, git diff, git logを使って現在の状況を把握しよう",
    category: "basic",
    objectives: [
    ...
    tasks: [
      {
        id: "status-check-1",
        description: "git statusで現在の状態を確認する",
        hint: "ターミナルに「git status」と入力してください",
        command: "git status",
        check: () => false, // 手動完了
        completed: false
      },
      {
        ...
        description: "README.mdの内容を変更する",
        hint: "README.mdファイルを選択して、内容を編集してください（例：説明文を追加）",
        check: (state) => {
          const originalContent = "# My Project\n\nThis is my first Git project.";
          return state.files['README.md'] && state.files['README.md'] !== originalContent;
        },
        completed: false
      },
      {
        id: "status-check-2",
        description: "変更後にgit statusで状態を確認する",
        hint: "ファイルを変更した後、再度「git status」を実行してください",
        command: "git status",
        check: () => false, // 手動完了
        completed: false
      },
      {
        id: "diff-check",
        description: "git diffで変更内容を確認する",
        hint: "ターミナルに「git diff」と入力して、具体的な変更内容を確認してください",
        command: "git diff",
        check: () => false, // 手動完了
        completed: false
      },
      {
        id: "stage-changes",
        description: "変更をステージングする",
        hint: "「git add README.md」でファイルをステージングしてください",
        command: "git add README.md",
        check: (state) => state.staged.includes('README.md'),
        completed: false
      },
      {
        id: "second-commit",
        description: "2回目のコミットを作成する",
        hint: "「git commit -m \"Update README\"」でコミットを作成してください",
      ...
      {
        id: "log-check",
        description: "git logでコミット履歴を確認する",
        hint: "ターミナルに「git log」と入力して、これまでのコミット履歴を確認してください",
        command: "git log",
        check: () => false, // 手動完了
        completed: false
      }
    ...
    badge: {
      id: "status-master",
      name: "状況把握マスター",
      description: "Gitの状態確認コマンドをマスターしました",
      icon: "📊",
      color: "purple",
      earned: false
    },
  ...
  },
  {
    id: 4,
    title: "ブランチとマージ",
    description: "ブランチを作成して並行開発を体験し、マージで統合しよう",
    category: "branch",
    objectives: [
    ...
    tasks: [
      {
        id: "create-branch",
        description: "new-featureブランチを作成する",
        hint: "ターミナルに「git branch new-feature」と入力してください",
        command: "git branch new-feature",
        check: (state) => state.branches['new-feature'] !== undefined,
        completed: false
      },
      {
        id: "check-branches",
        description: "git branchでブランチ一覧を確認する",
        hint: "ターミナルに「git branch」と入力して、ブランチ一覧を確認してください",
        command: "git branch",
        check: () => false, // 手動完了
        completed: false
      },
      {
        id: "switch-branch",
        description: "new-featureブランチに切り替える",
        hint: "ターミナルに「git switch new-feature」と入力してください",
        command: "git switch new-feature",
        check: (state) => state.currentBranch === 'new-feature',
        completed: false
      },
      {
        id: "create-about-file",
        description: "about.htmlファイルを作成する",
        hint: "ファイルエディタで新しいファイル「about.html」を作成し、自己紹介ページの内容を書いてください",
        check: (state) => state.files['about.html'] !== undefined && state.files['about.html'].length > 0,
        completed: false
      },
      {
        id: "add-about",
        description: "about.htmlをステージングする",
        hint: "「git add about.html」でファイルをステージングしてください",
        command: "git add about.html",
        check: (state) => state.staged.includes('about.html'),
        completed: false
      },
      {
        id: "commit-in-branch",
        description: "new-featureブランチでコミットする",
        hint: "「git commit -m \"Add about page\"」でコミットを作成してください",
        command: "git commit -m \"Add about page\"",
        check: (state) => {
          const branchCommits = state.commits.filter(c => c.branch === 'new-feature');
      ...
      },
      {
        ...
        hint: "「git switch main」でmainブランチに切り替えてください",
      ...
      {
        id: "merge-branch",
        description: "new-featureブランチをmainにマージする",
        hint: "「git merge new-feature」でブランチをマージしてください",
        command: "git merge new-feature",
        check: (state) => {
          // マージ後にabout.htmlがmainブランチに存在することを確認
          return state.files['about.html'] !== undefined;
        },
        completed: false
      }
    ],
    badge: {
      id: "branch-master",
      name: "ブランチマスター",
      description: "ブランチの作成とマージをマスターしました",
      icon: "🌿",
      color: "green",
      earned: false
    },
  ...
  },
  {
    id: 5,
    title: "リモート連携",
    description: "リモートリポジトリとの連携を学び、チーム開発の基礎を身につけよう",
    category: "remote",
    objectives: [
      "git cloneでリモートリポジトリを複製する",
      "git pushで変更をリモートに送信する",
      "git pullでリモートの変更を取得する"
    ],
    initialState: {
      files: {},
      staged: [],
    ...
    tasks: [
      {
        id: "clone-repo",
        description: "チームサイトをクローンする",
        hint: "ターミナルに「git clone https://github.com/example/team-site.git」と入力してください",
        command: "git clone https://github.com/example/team-site.git",
        check: (state) => {
          return state.remotes && state.remotes['origin'] && 
      ...
      {
        id: "check-remote",
        description: "リモートリポジトリの設定を確認する",
        hint: "ターミナルに「git remote -v」と入力して、リモートの設定を確認してください",
      ...
      {
        id: "edit-index-title",
        description: "index.htmlのタイトルを変更する",
        hint: "index.htmlファイルを開いて、<title>タグの内容を「新しいチームサイト」に変更してください",
        check: (state) => {
          return state.files['index.html'] && 
                 state.files['index.html'].includes('<title>新しいチームサイト</title>');
        },
        completed: false
      },
      {
        id: "stage-title-change",
        description: "変更をステージングする",
        hint: "「git add index.html」で変更をステージングしてください",
        command: "git add index.html",
        check: (state) => state.staged.includes('index.html'),
        completed: false
      },
      {
        id: "commit-title-change",
        description: "タイトル変更をコミットする",
        hint: "「git commit -m \"Update site title\"」でコミットを作成してください",
        command: "git commit -m \"Update site title\"",
        check: (state) => {
          return state.commits.some(commit => 
            commit.author === 'Student' && commit.hash !== 'team001'
          );
        },
        completed: false
      },
      {
        id: "push-changes",
        description: "変更をリモートにプッシュする",
        hint: "ターミナルに「git push origin main」と入力して、変更をリモートに送信してください",
      ...
      },
      {
        ...
        description: "リモートから最新の変更を取得する",
        hint: "ターミナルに「git pull origin main」と入力して、チームメンバーの変更を取得してください",
    ...
    badge: {
      ...
      name: "リモート連携マスター",
      description: "リモートリポジトリとの連携をマスターしました",
      icon: "🌐",
      color: "blue",
      earned: false
    },
  ...
  },
  {
    id: 6,
    title: "コンフリクト解決",
    description: "コンフリクトの発生から解決まで、実際のチーム開発で起こる問題を解決しよう",
    category: "conflict",
    objectives: [
      "コンフリクトが発生する原因を理解する",
      "コンフリクトマーカーの読み方を学ぶ",
    ...
    tasks: [
      {
        ...
        description: "feature-titleブランチを作成する",
        hint: "ターミナルに「git branch feature-title」と入力してください",
        command: "git branch feature-title",
        check: (state) => state.branches['feature-title'] !== undefined,
        completed: false
      },
      {
        id: "switch-to-feature",
        description: "feature-titleブランチに切り替える",
        hint: "ターミナルに「git switch feature-title」と入力してください",
        command: "git switch feature-title",
        check: (state) => state.currentBranch === 'feature-title',
        completed: false
      },
      {
        id: "edit-h1-in-feature",
        description: "見出しを「Welcome to My Site」に変更する",
        hint: "index.htmlファイルの<h1>タグの内容を「Welcome to My Site」に変更してください",
        check: (state) => {
          return state.files['index.html'] && 
                 state.files['index.html'].includes('<h1>Welcome to My Site</h1>');
        },
        completed: false
      },
      {
        id: "stage-feature-change",
        description: "変更をステージングする",
        hint: "「git add index.html」で変更をステージングしてください",
        command: "git add index.html",
        check: (state) => state.staged.includes('index.html'),
      ...
      {
        id: "commit-feature-change",
        description: "feature-titleブランチでコミットする",
        hint: "「git commit -m \"Update heading to welcome message\"」でコミットを作成してください",
        command: "git commit -m \"Update heading to welcome message\"",
        check: (state) => {
          const featureCommits = state.commits.filter(c => c.branch === 'feature-title');
          return featureCommits.length > 0;
        },
        completed: false
      },
      {
      ...
      {
        id: "simulate-team-change",
        description: "Aさんの変更を模擬する（同じ見出しを「Hello from Team!」に変更）",
        hint: "index.htmlファイルの<h1>タグの内容を「Hello from Team!」に変更してください（Aさんの変更を模擬）",
        check: (state) => {
          return state.files['index.html'] && 
                 state.files['index.html'].includes('<h1>Hello from Team!</h1>');
        },
        completed: false
      },
      {
        id: "stage-main-change",
        description: "mainでの変更をステージング・コミットする",
        hint: "「git add index.html」→「git commit -m \"Team update heading\"」でAさんの変更をコミットしてください",
        command: "git add index.html && git commit -m \"Team update heading\"",
        check: (state) => {
          const mainCommits = state.commits.filter(c => c.branch === 'main');
          return mainCommits.length >= 2;
        },
        completed: false
      },
      {
        id: "attempt-merge",
        description: "feature-titleをマージしてコンフリクトを発生させる",
        hint: "ターミナルに「git merge feature-title」と入力してください。コンフリクトが発生します",
        command: "git merge feature-title",
        check: () => false, // 手動完了（コンフリクト発生）
        completed: false
      },
      {
        id: "resolve-conflict",
        description: "コンフリクトを解決する（両方の内容を統合）",
        hint: "index.htmlファイルのコンフリクトマーカー（<<<<<<<, =======, >>>>>>>）を削除し、「Welcome to My Site and Team!」に統合してください",
        check: (state) => {
          return state.files['index.html'] && 
                 state.files['index.html'].includes('<h1>Welcome to My Site and Team!</h1>') &&
                 !state.files['index.html'].includes('<<<<<<<') &&
                 !state.files['index.html'].includes('=======') &&
                 !state.files['index.html'].includes('>>>>>>>');
        },
        completed: false
      },
      {
        ...
        description: "解決済みファイルをステージングする",
        hint: "「git add index.html」で解決済みファイルをステージングしてください",
        command: "git add index.html",
        check: (state) => state.staged.includes('index.html'),
        completed: false
      },
      {
        id: "commit-merge",
        description: "マージコミットを完了する",
        hint: "「git commit」でマージコミットを作成してください（メッセージはデフォルトでOK）",
        command: "git commit",
        check: (state) => {
          // マージ後に統合された内容が存在することを確認
          return state.files['index.html'] && 
                 state.files['index.html'].includes('<h1>Welcome to My Site and Team!</h1>');
        },
        completed: false
    ...
    badge: {
      ...
      name: "コンフリクト解決マスター",
      description: "コンフリクトの解決方法をマスターしました",
      icon: "⚡",
      color: "orange",
      earned: false
    },
  ...
  },
  {
    id: 7,
    title: "実務模擬シナリオ",
    description: "実際のチーム開発フローを体験し、Issue対応からPRマージまでの流れを学ぼう",
    category: "practical",
    objectives: [
      "Issue駆動開発を体験する",
      "適切なブランチ命名規則を学ぶ",
      "Pull Requestの作成からマージまでの流れを理解する"
    ],
    initialState: {
      files: {
        "README.md": "# チームプロジェクト\n\nWeb制作チームの共同プロジェクトです。\n\n## 現在の課題\n- Issue #12: ヘッダー追加（担当：あなた）\n\n## チームメンバー\n- 田中さん（プロジェクトマネージャー）\n- 佐藤さん（シニア開発者）\n- あなた（開発者）",
      ...
      branches: { main: "project001" },
      currentBranch: "main",
      head: "project001",
      initialized: true,
      remotes: { origin: "https://github.com/team/project.git" }
    },
    tasks: [
      {
        id: 'check-issue',
        description: 'Issue #12の内容を確認する（確認後、「内容を確認しました」ボタンをクリック）',
        hint: 'Issue #12: ヘッダー追加 - サイト上部にナビゲーションバーを追加してください。仕様を理解したら「内容を確認しました」ボタンを押してください。',
        check: () => false, // Manual completion required
        completed: false
      },
      {
        id: "create-feature-branch",
        description: "feature/add-headerブランチを作成・切り替える",
        hint: "ターミナルに「git switch -c feature/add-header」と入力してください",
        command: "git switch -c feature/add-header",
        check: (state) => state.currentBranch === 'feature/add-header' && state.branches['feature/add-header'] !== undefined,
        completed: false
      },
      {
        id: 'create-header-file',
        description: 'header.htmlファイルを作成し、ナビゲーションメニューを実装する',
        hint: 'ファイルエディタで新しいファイルを作成し、HTMLでナビゲーションを実装してください。「答えを表示」で実装例を確認できます。',
  ...
  <header>
    <nav>
      <ul>
        ...
        check: (state) => {
          return state.files['header.html'] && 
                 state.files['header.html'].includes('<header>') &&
                 state.files['header.html'].includes('<nav>') &&
                 state.files['header.html'].includes('ホーム') &&
                 state.files['header.html'].includes('サービス') &&
                 state.files['header.html'].includes('お問い合わせ');
        },
        completed: false
      },
      {
        id: "stage-header",
        description: "header.htmlをステージングする",
        hint: "「git add header.html」でファイルをステージングしてください",
        command: "git add header.html",
        check: (state) => state.staged.includes('header.html'),
        completed: false
      },
      {
        id: "commit-header",
        description: "ヘッダー追加をコミットする",
        hint: "「git commit -m \"Add site header\"」でコミットを作成してください",
        command: "git commit -m \"Add site header\"",
        check: (state) => {
          const featureCommits = state.commits.filter(c => c.branch === 'feature/add-header');
          return featureCommits.length > 0;
        },
        completed: false
      },
      {
        ...
        description: "feature/add-headerブランチをリモートにプッシュする",
        hint: "ターミナルに「git push origin feature/add-header」と入力してください",
        command: "git push origin feature/add-header",
        check: (state) => {
          // pushコマンドが実行されたかどうかは、実際のコマンド実行で判定
          return false; // handleCommandで直接完了処理を行う
        },
        completed: false
      },
      {
        id: "create-pull-request",
        description: "Pull Requestを作成する（模擬）",
        hint: "実際の開発では、GitHubでPull Requestを作成します。ここでは作成したと仮定して次に進んでください",
        check: () => false, // 手動完了
        completed: false
      },
      {
        id: "switch-to-main-for-merge",
        description: "mainブランチに切り替える",
        hint: "「git switch main」でmainブランチに戻ってください",
        command: "git switch main",
        check: (state) => state.currentBranch === 'main',
        completed: false
      },
      {
        id: "merge-feature",
        description: "feature/add-headerをmainにマージする",
        hint: "「git merge feature/add-header」でブランチをマージしてください",
        command: "git merge feature/add-header",
        check: (state) => {
          return state.files['header.html'] !== undefined;
        },
        completed: false
      },
      {
        id: "cleanup-branch",
        description: "不要になったブランチを削除する",
        hint: "「git branch -d feature/add-header」でローカルブランチを削除してください",
        command: "git branch -d feature/add-header",
        check: (state) => state.branches['feature/add-header'] === undefined,
        completed: false
      }
    ],
    badge: {
      id: "practical-master",
      name: "実務マスター",
      description: "実際のチーム開発フローをマスターしました",
      icon: "💼",
      color: "gold",
      earned: false
    },
